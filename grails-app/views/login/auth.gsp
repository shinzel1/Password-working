            ...
            <div class="card-body">
                ...
                <form class="form-signin" action="${postUrl ?: '/login/authenticate'}" method="POST" id="loginForm" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <g:passwordField name="${passwordParameter ?: 'password'}"  id="password"  type="password" class="form-control"/>
%{--                        <input type="password" class="form-control" name="${passwordParameter ?: 'password'}" id="password"/>--}%
                    ...
                    <hr class="my-4">
                    <p><g:link controller="user" action="forgotPassword">Forgot Password</g:link></p>
                </form>
            </div>
        </div>
    </div>
